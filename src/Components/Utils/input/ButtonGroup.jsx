...
const ButtonGroup = ({ pet }) => {
  return (
    <div className="">
      {/* Botón de WhatsApp */}
      {pet.data.numberphone && (
        <button className="mb-2 mb-md-0 me-md-2 text-center btn">
          <a
            href={`https://wa.me/${pet.data.numberphone}`}
            target="_blank"
            rel="noopener noreferrer"
            className="btn btn-success d-flex align-items-center text-center"
          >
            <svg
      ...
      {/* Botón de Facebook */}
      {pet.data.facebook && (
        <button className="mb-2 mb-md-0 ms-md-2 btn">
          <a
            href={`https://www.facebook.com/${pet.data.facebook}/`}
            target="_blank"
            rel="noopener noreferrer"
